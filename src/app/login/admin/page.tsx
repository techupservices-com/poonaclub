      ...
      <div className="mx-auto grid max-w-4xl gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <section className="shell-panel relative overflow-hidden rounded-[34px] p-6 md:p-8">
          ...
          <div className="relative">
            <p className="font-mono text-xs uppercase tracking-[0.34em] text-rose-700">Poona Club admin access</p>
            ...
            <div className="mt-8 grid gap-3">
              <div className="rounded-[22px] border border-white/70 bg-white/80 px-4 py-4 text-sm text-[var(--muted)] shadow-sm">
                <span className="font-mono text-xs uppercase tracking-[0.24em] text-rose-700">Member search</span>
              ...
              <div className="rounded-[22px] border border-white/70 bg-white/80 px-4 py-4 text-sm text-[var(--muted)] shadow-sm">
                <span className="font-mono text-xs uppercase tracking-[0.24em] text-rose-700">System-driven review</span>
        ...
        <section className="soft-card rounded-[34px] border-white/70 bg-white/88 p-6 md:p-8">
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-rose-700">Admin login</p>
